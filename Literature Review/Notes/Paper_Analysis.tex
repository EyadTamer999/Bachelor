...
\newpage
\input{Art of Computer Game Design.tex}

\newpage
\input{Automatic generation and recommendation of personalized challenges for gamiﬁcation.tex}

\newpage
\input{MDA A Formal Approach to Game Design and Game Research.tex}

\newpage
\input{Categorizing Game Design Elements into Educational Game Design Fundamentals.tex}

\newpage
\input{Analysis of Game Design FrameworkThrough Elemental Tetrad.tex}

\newpage
\input{SGAME An Authoring Tool to Easily Create Educational Video Games by Integrating SCORM-Compliant Learning Objects.tex}

\newpage
\input{Towards Automatic Personalized Content Generation for Platform Games.tex}

\newpage
\input{Comparing Traditional Teaching and Game-Based Learning using Teacher-Authored Games on Computer Science Education.tex}

\newpage
\input{VoRtex Metaverse Platform for Gamified Collaborative Learning.tex}
